...
export const UserLocalizationSettingsContext = /*#__PURE__*/React.createContext({
...
export const useUserLocalizationSettings = () => React.useContext(UserLocalizationSettingsContext);
export const USER_LOCALIZATION_SETTINGS_STORAGE_KEY = "@user-localization-settings";
export function UserLocalizationSettingsProvider(_ref) {
  let {
    i18n,
  ...
  return /*#__PURE__*/React.createElement(UserLocalizationSettingsContext.Provider, {
    value: {
      localizationSettings,
