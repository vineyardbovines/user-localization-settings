...
exports.UserLocalizationSettingsContext = exports.USER_LOCALIZATION_SETTINGS_STORAGE_KEY = void 0;
exports.UserLocalizationSettingsProvider = UserLocalizationSettingsProvider;
exports.useUserLocalizationSettings = void 0;
...
const UserLocalizationSettingsContext = /*#__PURE__*/_react.default.createContext({
  ...
  setLocalizationSettings: () => console.warn("UserLocalizationContext: Provider not set")
});

exports.UserLocalizationSettingsContext = UserLocalizationSettingsContext;

const useUserLocalizationSettings = () => _react.default.useContext(UserLocalizationSettingsContext);

exports.useUserLocalizationSettings = useUserLocalizationSettings;
const USER_LOCALIZATION_SETTINGS_STORAGE_KEY = "@user-localization-settings";
exports.USER_LOCALIZATION_SETTINGS_STORAGE_KEY = USER_LOCALIZATION_SETTINGS_STORAGE_KEY;

function UserLocalizationSettingsProvider(_ref) {
  let {
    i18n,
  ...
  return /*#__PURE__*/_react.default.createElement(UserLocalizationSettingsContext.Provider, {
    value: {
      localizationSettings,
